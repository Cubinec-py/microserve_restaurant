...
from .views import OrderListView, InterfaceView, TipsDetailView, RestaurantStatsDetailView
...
urlpatterns = [
    ...
    path('restaurant_stats/', RestaurantStatsDetailView.as_view(), name='restaurant_stats'),
]
